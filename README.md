...
This is the code for our paper [DynaMoN: Motion-Aware Fast and Robust Camera Localization for Dynamic Neural Radiance Fields](https://ieeexplore.ieee.org/document/10777295).

The original code can base can be found here: [https://github.com/HannahHaensen/DynaMoN](https://github.com/HannahHaensen/DynaMoN), for questions please reach out to the original repo.
